    ...
    configFields: [
      {
        ...
        helpText: "Comma-separated list of Kafka broker addresses (host:port)",
        group: "Connection",
      },
      {
        key: "topics",
      ...
      },
      {
        ...
        options: [
          { value: "PLAINTEXT", label: "PLAINTEXT (no auth)" },
          { value: "SSL", label: "SSL" },
          { value: "SASL_PLAINTEXT", label: "SASL_PLAINTEXT" },
          { value: "SASL_SSL", label: "SASL_SSL" },
        ],
        helpText: "Kafka broker security protocol",
      ...
      },
      {
        ...
        dependsOn: { field: "securityProtocol", values: ["SASL_SSL", "SASL_PLAINTEXT"] },
        helpText: "SASL authentication mechanism",
        group: "Authentication",
      },
      {
        key: "saslUsername",
        ...
        dependsOn: { field: "securityProtocol", values: ["SASL_SSL", "SASL_PLAINTEXT"] },
        helpText: "Username for SASL authentication",
        group: "Authentication",
      },
      {
        key: "saslPassword",
        ...
        placeholder: "••••••••",
        dependsOn: { field: "securityProtocol", values: ["SASL_SSL", "SASL_PLAINTEXT"] },
        helpText: "Password for SASL authentication (use Databricks Secrets in production)",
        group: "Authentication",
      },
      {
        ...
        defaultValue: "PEM",
        options: [
          { value: "PEM", label: "PEM (CA certificate)" },
          { value: "JKS", label: "JKS" },
          { value: "PKCS12", label: "PKCS12" },
        ],
        dependsOn: { field: "securityProtocol", values: ["SSL", "SASL_SSL"] },
        helpText: "Type of SSL truststore",
        group: "Authentication",
      },
      {
        key: "sslTruststoreLocation",
        label: "CA Certificate / Truststore Path",
        type: "text",
        required: false,
        placeholder: "/dbfs/certs/ca.pem or dbfs:/certs/ca.pem",
        dependsOn: { field: "securityProtocol", values: ["SSL", "SASL_SSL"] },
        helpText: "Path to the CA certificate or truststore file (upload to DBFS or a Volume first)",
        group: "Authentication",
      },
      {
        key: "startingOffset",
